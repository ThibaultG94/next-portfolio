...
const Contact = () => {
  ...
  return (
    <section className="section-container flex items-center justify-center px-3">
          ...
          <div className="md:flex-1 2xl:w-full space-y-4">
            ...
            <div className="md:flex-1 2xl:w-full">
              <textarea
                ...
                onChange={handleFormChange}
                className="w-full h-full p-2 sm:p-2.5 md:p-3 2xl:p-4 text-sm sm:text-base 2xl:text-lg rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-200"
              />
            </div>
          </div>

          {/* Section for reCAPTCHA and button - remains full-width */}
            ...
            {sitekey && (
              <div className="flex justify-center">
                <ReCAPTCHA
                  ...
                  size={window.innerWidth >= 1280 ? "normal" : "compact"}
                />
              </div>
            )}

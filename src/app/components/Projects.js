...
const projets = [
  {
    ...
    images: [
      "/img/task-manager/01_task-manager-dashboard.png",
      "/img/task-manager/02_task-manager-dashboard-messagerie.png",
      "/img/task-manager/03_task-manager-taskspage.png",
      "/img/task-manager/04_task-manager-taskspage-messagerie.png",
      "/img/task-manager/05_task-manager-new-task.png",
      "/img/task-manager/06_task-manager-new-workspace.png",
      "/img/task-manager/07_task-manager-contacts.png",
      "/img/task-manager/08_task-manager-new-contact.png",
      "/img/task-manager/09_task-manager-workspaces.png",
      "/img/task-manager/10_task-manager-contact.png",
      "/img/task-manager/11_task-manager-task.png",
      "/img/task-manager/12_task-manager-messages.png",
      "/img/task-manager/13_task-manager-notifications.png",
      "/img/task-manager/14_task-manager-notifications-menu.png",
      "/img/task-manager/15_task-manager-workspace.png",
      "/img/task-manager/16_task-manager-invitation-received.png",
      "/img/task-manager/17_task-manager-invitation-send.png",

      ...
      <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center">
        ...
        {fullSizeImage && (
          ...
          >
            <button
              onClick={prevImage}
              className="absolute left-4 top-1/2 transform -translate-y-1/2 text-2xl text-gray-200 hover:text-gray-800 transition duration-300 z-10"
            >
              <FaArrowLeft />
            </button>
            <Image
            ...
            <button
              onClick={nextImage}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 text-2xl text-gray-200 hover:text-gray-800 transition duration-300 z-10"
            >
              <FaArrowRight />
            </button>
          </div>
...
export default ProjectsModalTablet;
